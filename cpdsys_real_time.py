...
# ========================
# Video Capture Detection (Real Time Detection)
# ========================

# cap = cv2.VideoCapture("https://192.168.43.179:8080/video") # for android app ip webcam
cap = cv2.VideoCapture(1)

# IMAGE_PATH = os.path.join(paths['IMAGE_PATH'], 'results', 'gopro7.mp4')
...
while cap.isOpened(): 
    ...
    # detects and extracts the plate number
    try:
    ...
    # cv2.imshow('object detection',  cv2.resize(region, (800, 600)))    
